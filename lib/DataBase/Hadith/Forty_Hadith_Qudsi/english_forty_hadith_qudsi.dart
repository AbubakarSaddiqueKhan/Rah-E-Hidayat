class EnglishFortyHadithQudsi {
  static const String englishFortyHadithQudsiJsonData = """
  
  {
	...
	"hadiths": [
		...
		},
		{
			"hadithnumber": 11,
			"arabicnumber": 11,
			"text": "On the authority of Abu Harayrah (may Allah be pleased with him) from the Prophet (ﷺ), who said: Allah (mighty and sublime be He) said: Spend (on charity), O son of Adam, and I shall spend on you. It was related by al-Bukhari (also by Muslim)",
			"grades": [],
			"reference": {
				"book": 1,
				"hadith": 11
